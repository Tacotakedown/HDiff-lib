...
static INLINE saint_t ss_compare(const sauchar_t *T, const sastore_t *p1,
                                 const sastore_t *p2, saidx_t depth) {
...
static void ss_insertionsort(const sauchar_t *T, const sastore_t *PA,
...
static INLINE void ss_fixdown(const sauchar_t *Td, const sastore_t *PA,
...
static void ss_heapsort(const sauchar_t *Td, const sastore_t *PA, sastore_t *SA,
                        saidx_t size) {
  saidx_t i, m;
  saidx_t t;
...
static INLINE sastore_t *ss_median3(const sauchar_t *Td, const sastore_t *PA,
                                    sastore_t *v1, sastore_t *v2,
                                    sastore_t *v3) {
  sastore_t *t;
...
static INLINE sastore_t *ss_median5(const sauchar_t *Td, const sastore_t *PA,
                                    sastore_t *v1, sastore_t *v2, sastore_t *v3,
                                    sastore_t *v4, sastore_t *v5) {
  sastore_t *t;
  if (Td[PA[*v2]] > Td[PA[*v3]]) {
    SWAP(v2, v3);
  }
...
static INLINE sastore_t *ss_pivot(const sauchar_t *Td, const sastore_t *PA,
...
static INLINE sastore_t *ss_partition(const sastore_t *PA, sastore_t *first,
                                      sastore_t *last, saidx_t depth) {
  sastore_t *a, *b;
  saidx_t t;
...
static void ss_mintrosort(const sauchar_t *T, const sastore_t *PA,
                          sastore_t *first, sastore_t *last, saidx_t depth) {
#define STACK_SIZE SS_MISORT_STACKSIZE
  ...
  for (ssize = 0, limit = ss_ilg((saidx_t)(last - first));;) {
    ...
    if (a <= d) {
      ...
      if ((s = (saidx_t)(a - first)) > (t = (saidx_t)(b - a))) {
        s = t;
      }
      for (e = first, f = b - s; 0 < s; --s, ++e, ++f) {
        SWAP(*e, *f);
      }
      if ((s = (saidx_t)(d - c)) > (t = (saidx_t)(last - d - 1))) {
        s = t;
      }
...
static INLINE void ss_blockswap(sastore_t *a, sastore_t *b, saidx_t n) {
  saidx_t t;
  for (; 0 < n; --n, ++a, ++b) {
    t = *a, *a = *b, *b = t;
  }
...
static INLINE void ss_rotate(sastore_t *first, sastore_t *middle,
                             sastore_t *last) {
  sastore_t *a, *b, t;
  saidx_t l, r;
...
static void ss_inplacemerge(const sauchar_t *T, const sastore_t *PA,
                            sastore_t *first, sastore_t *middle,
                            sastore_t *last, saidx_t depth) {
  const sastore_t *p;
  sastore_t *a, *b;
  saidx_t len, half;
...
static void ss_mergeforward(const sauchar_t *T, const sastore_t *PA,
                            sastore_t *first, sastore_t *middle,
                            sastore_t *last, sastore_t *buf, saidx_t depth) {
...
static void ss_mergebackward(const sauchar_t *T, const sastore_t *PA,
                             sastore_t *first, sastore_t *middle,
                             sastore_t *last, sastore_t *buf, saidx_t depth) {
...
/* D&C based merge. */
static void ss_swapmerge(const sauchar_t *T, const sastore_t *PA,
...
#define MERGE_CHECK(a, b, c)                                                   \
  ...
  for (check = 0, ssize = 0;;) {
    ...
    for (m = 0, len = (saidx_t)(MIN(middle - first, last - middle)),
        half = len >> 1;
         0 < len; len = half, half >>= 1) {
...
/* Substring sort */
void sssort(const sauchar_t *T, const sastore_t *PA, sastore_t *first,
            sastore_t *last, sastore_t *buf, saidx_t bufsize, saidx_t depth,
